...
import org.apache.spark.sql.execution.exchange.{EnsureRequirements, EnsureRequirementsLike, ShuffleExchangeExec}
...
case class OptimizeLocalShuffleReader(
    conf: SQLConf,
    ensureRequirements: Rule[SparkPlan]) extends Rule[SparkPlan] {
